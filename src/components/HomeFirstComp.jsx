...
import one from '../Videos/Gifting-01.mp4';
import two from '../Videos/Gifting-02.mp4';
import three from '../Videos/Gifting-03.mp4';

function HomeFirstComp() {
  const slides = [
    {
      src: one,
      alt: "Celebrate the season with gifts crafted in elegance and timeless luxury.",
      heading1: (
    ...
    {
      src: two,
      alt: "Crafted to dazzle, designed to serve — luxury in every detail.",
      heading1: (
