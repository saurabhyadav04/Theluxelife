      ...
      <div className="flex flex-col lg:flex-row justify-between gap-10 max-w-screen-xl mx-auto">
        ...
        <div className="flex-1 space-y-8 text-[#1c1c1c] text-[16px] sm:text-[18px] leading-relaxed">
          ...
          <div>
           ...
           {/* Ocasion by Prices */}
          <div>
            <h3 className="font-semibold ">Shop by Recipient:</h3>
            <p className="space-x-1 space-y-2">
              <a href="/products/for-her" className="hover:underline">For-her</a> |{" "}
              <a href="/products/for-him" className="hover:underline">For-him</a> |{" "}
              <a href="/products/for-couples" className="hover:underline">For Couples</a> |{" "}
              <a href="/products/bridesmaid" className="hover:underline">Bridesmaid</a> |{" "}
              <a href="/products/stationery-lover" className="hover:underline">Stationery lover</a>
            </p>
          </div>

           {/* Ocasion by Prices */}
          <div>
            <h3 className="font-semibold ">Shop by Occasion:</h3>
            <p className="space-x-1 space-y-2">
              <a href="/products/wedding" className="hover:underline">Wedding</a> |{" "}
              <a href="/products/festive" className="hover:underline">Festive</a> |{" "}
              <a href="/products/corporate" className="hover:underline">Corporate</a> |{" "}
              <a href="/products/housewarming" className="hover:underline">Housewarming</a> |{" "}
              <a href="/products/thank-you" className="hover:underline">Thank You</a> |{" "}
              <a href="/products/baby-announcements" className="hover:underline">Baby Announcements</a>   
            </p>
          </div>
