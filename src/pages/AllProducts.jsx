...
const AllProducts = () => {
  ...
  return (
    <>
    <Helmet>
        <title>LuxeLife | Sustainable & Personalized Gift Hampers Online </title>
        <meta
          name="description"
          content="Browse our curated range of sustainable and personalized hampers. From luxury gift hampers India to unique corporate gifts, find the perfect hamper."
          data-rh="true"
        />
      </Helmet>
